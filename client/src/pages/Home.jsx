...
const Home = () => {
  ...
  return <>
    <div className="relative md:p1-64 flex mid-h-screen bg-gray-100">
      <div className="md:hidden z-10 absolute right-6 top-4 sm:top-6 flex justify-center items-end bg-black rounded-md h-9 w-9 text-white">
