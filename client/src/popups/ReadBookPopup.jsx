  ...
  return (
    <div className='fixed inset-0 bg-black bg-opacity-50 p-5 flex item-center justify-center z-50'>
      ...
      <div className='flex justify-between items-center bg-black text-white px-6 py-4 rounded-t-lg'>
        ...
        <button className='text-white' onClick={()=>dispatch(toggleReadBookPopup())}>&times;</button>
      </div>
     
     <div className='p-6'>
      <div className='mb-4'>
        <label className='border border-gray-700 font-semibold'> Book Title </label>
        <p className='border border-gray-300 rounded-lg px-4 py-2 bg-gray-100'>{book && book.title}</p>
      </div>
      <div className='mb-4'>
        <label className='border border-gray-700 font-semibold'> Author</label>
        <p className='border border-gray-300 rounded-lg px-4 py-2 bg-gray-100'>{book && book.author}</p>
      </div>
      <div className='mb-4'>
        <label className='border border-gray-700 font-semibold'> Description </label>
