      ...
      <div className='w-full bg-white rounded-lg shadow-lg md:w-1/3'>
        <div className='p-6'>
          ...
          <form onSubmit={handleRecordBook}>
            <div className='mb-4'>
              <label className='black text-gray-900 font-medium'>User Email</label>
              <input type="email" value={email} onChange={(e)=>setEmail(e.target.value)} required placeholder='Borrower Email' className='w-full px-4 py-2 border-2 border-black rounded-md' />
            </div>
            <div className='flex justify-end space-x-4'>
              <button className='px-4 py-2 bg-gray-200 rounded-md hover' type='button' onClick={dispatch(toggleRecordBookPopup())}>Close</button>
